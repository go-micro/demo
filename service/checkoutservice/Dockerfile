...
RUN go build -gcflags="${SKAFFOLD_GO_GCFLAGS}" -o /go/src/hipstershop/checkoutservice .
...
COPY --from=builder /go/src/hipstershop/checkoutservice /hipstershop/checkoutservice
