...
RUN go build -gcflags="${SKAFFOLD_GO_GCFLAGS}" -o /go/src/hipstershop/shippingservice . 
...
COPY --from=builder /go/src/hipstershop/shippingservice /hipstershop/shippingservice
