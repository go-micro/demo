...
RUN go build -gcflags="${SKAFFOLD_GO_GCFLAGS}" -o /go/src/hipstershop/currencyservice . 
...
COPY --from=builder /go/src/hipstershop/currencyservice /hipstershop/currencyservice
