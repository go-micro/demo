...
RUN go build -gcflags="${SKAFFOLD_GO_GCFLAGS}" -o /go/src/hipstershop/paymentservice . 
...
COPY --from=builder /go/src/hipstershop/paymentservice /hipstershop/paymentservice
